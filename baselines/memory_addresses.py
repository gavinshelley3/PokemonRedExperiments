...
ITEM_BAG_START = 0xD31D
ITEM_BAG_END = 0xD346

PARTY_POKEMON_COUNT = 0xD163
POKEDEX_CAUGHT_ADDRESSES = [0xD2F3, 0xD2F4, 0xD2F5, 0xD2F6, 0xD2F7, 0xD2F8]
POKEDEX_OWNED_START = 0xD2F3
POKEDEX_OWNED_END = 0xD2F2
